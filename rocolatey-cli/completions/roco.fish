...
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "list" -d 'list local installed packages'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "bad" -d 'list packages in lib-bad/'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "outdated" -d 'Returns a list of outdated packages.'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "source" -d 'list choco sources'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "search" -d 'search for packages'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "license" -d 'display license information'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "upgrade" -d 'upgrade outdated choco packages (using choco.exe)'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "install" -d 'install choco packages (using choco.exe)'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "uninstall" -d 'uninstall choco packages (using choco.exe)'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "server" -d 'manage roco server configuration and TLS setup'
complete -c roco -n "__fish_roco_using_subcommand help; and not __fish_seen_subcommand_from list bad outdated source search license upgrade install uninstall server help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
